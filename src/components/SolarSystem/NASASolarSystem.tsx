...
const NASASolarSystem: React.FC<NASASolarSystemProps> = ({ resetTrigger = 0, onCameraDistanceChange, onPlanetClick, onSunClick }) => {
  ...
  useEffect(() => {
    ...
    const planetsData = [
      ...
      { name: 'Mars', label: 'Experience', size: 0.8, dist: 19, speed: 0.00053, texture: 'mars.jpg', route: '/resume?resume=experience', initialAngle: 0.9, moons: [{ size: 0.1, dist: 1.5, speed: 0.05 }, { size: 0.08, dist: 2, speed: 0.03 }] },
      { name: 'Jupiter', label: 'Education', size: 2, dist: 25, speed: 0.000084, texture: 'jupiter.jpg', route: '/resume?resume=education', initialAngle: 2.7, moons: [{ size: 0.15, dist: 3, speed: 0.02 }, { size: 0.13, dist: 3.5, speed: 0.015 }, { size: 0.2, dist: 4, speed: 0.01 }, { size: 0.18, dist: 4.5, speed: 0.008 }] },
      { name: 'Saturn', label: 'Skills', size: 1.7, dist: 31, speed: 0.000034, texture: 'saturn.jpg', route: '/resume?resume=skills', initialAngle: 5.8, hasRings: true, moons: [{ size: 0.12, dist: 3, speed: 0.015 }, { size: 0.1, dist: 3.5, speed: 0.012 }, { size: 0.15, dist: 4, speed: 0.01 }] },
      { name: 'Uranus', label: 'Certifications', size: 1.2, dist: 37, speed: 0.000012, texture: 'uranus.jpg', route: '/resume?resume=certifications', initialAngle: 1.2, moons: [{ size: 0.1, dist: 2.5, speed: 0.018 }, { size: 0.09, dist: 3, speed: 0.015 }] },
